...
<Timeline
  items={[
    ...
    },
    {
      title: 'PocketGuard',
      description:
        'PocketGuard is ideal for newcomers to personal finance apps or those overwhelmed by complex features. It offers user-friendly interface, creative design for easy navigation, comprehensive budgeting tools, and great support resources. The app offers a free version and a premium subscription for extra features.',
      icon: 'tabler:shield',
    },
    {
      title: 'Monarch Money',
      description:
        'Monarch Money suits detail-oriented users who are managing many family finances. Features include visually appealing and customizable interface, comprehensive account linking (bank, investment, property), net worth tracking over time, and collaborative features for family finance management. Monarch charges $14.99 per month or $99.99 annually, with a one-week free trial.',
      icon: 'tabler:crown',
    },
  ]}
  classes={{
